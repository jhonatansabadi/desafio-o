...
public class Operability {
    ...
    public boolean isHas_operations_on_thursdays() {
    ...
    public boolean isHas_operations_on_wednesdays() {
    ...
    public boolean isHas_operations_on_tuesdays() {
    ...
    public boolean isHas_operations_on_mondays() {
    ...
    public boolean isHas_operations_on_fridays() {
